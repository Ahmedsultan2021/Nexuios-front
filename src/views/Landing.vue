<template>
  <div>
          ...
          <div class="col px-0">
            <div class="row">
              <div class="col-lg-6">
                ...
                Nexus Co-Working           
            <span>Collaborate to Innovate</span>
                </h1>
                <p class="lead text-white font-weight-bold">
                   a dynamic space where entrepreneurs, freelancers, and remote workers collaborate, innovate, and succeed. Join us to unleash your creativity and take your business to the next level.
                </p>
    ...
    <section id="servises" class="section section-lg pt-lg-0 mt--200">
      <div class="container">
            ...
            <div class="row row-grid">
              <div class="col-lg-4">
                <card class="border-0" hover shadow body-classes="py-5">
                  ...
                  <h6 class="text-primary text-uppercase">Business Coaching</h6>
                  <p class="description mt-3">
                   Our experienced business coaches can provide personalized guidance to help you develop your business idea, create a growth strategy, and overcome challenges.
                  </p>
                  <div>
              ...
              <div class="col-lg-4">
                <card class="border-0" hover shadow body-classes="py-5">
                  ...
                  <h6 class="text-success text-uppercase">Event Space Rental</h6>
                  <p class="description mt-3">
A modern, flexible, and fully-equipped space for meetings, workshops, and networking events of all sizes and types. Make your next event a success with us.                  </p>
                  <div>
              ...
              <div class="col-lg-4">
                <card class="border-0" hover shadow body-classes="py-5">
                  ...
                  <h6 class="text-warning text-uppercase">Virtual Office Services</h6>
                  <p class="description mt-3">
                   A professional address, mail handling, and phone answering for remote workers or small businesses seeking a professional presence without a physical office.
                  </p>
                  <div>
      ...
      <div class="container">
        <div class="row row-grid align-items-center">
          <div class="col-md-6 order-md-2">
            <img src="10/4-1.jpg" class="img-fluid floating" />
          </div>
          <div class="col-md-6 order-md-1">
            <div class="pr-md-5">
              ...
              <p>
               Joining Nexus Co-Working can provide several advantages for entrepreneurs, freelancers, and remote workers:
              </p>
                ...
                <li class="py-2">
                  <div class="d-flex align-items-center">
                    <badge
                      ...
                      icon="ni ni-html5"
                    ></badge>
                    <h6 class="mb-0">Networking Opportunities</h6>
                  </div>
                </li>
                <li class="py-2">
                  <div class="d-flex align-items-center">
                    ...
                    ></badge>
                    <h6 class="mb-0">Professional Workspace</h6>
                  </div>
                </li>
              </ul>
            </div>
    ...
    <section id="massage" class="section section-lg pt-lg-0 section-contact-us">
      <div class="container">
