    ...
    <base-nav class="navbar-main" transparent type="" effect="light" expand>
      ...
      <ul class="navbar-nav align-items-lg-center ml-lg-auto">
        ...
        <!-- <li class="nav-item d-none d-lg-block ml-lg-4">
          <button v-if="!isAuthenticated" @change="setProperty" class="btn btn-info">login</button>
          <button v-else @click="logout" class="btn btn-info">
            logout
          </button>
        </li> -->
      </ul>
...
export default {
  data() {
    return {
      user: {},
      authToken: null, // set to null by default
